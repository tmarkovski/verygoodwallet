 ...
 * ~1,600-char QR no phone camera can lock onto. Serving it back is safe:
 * the request is exactly what the by-value link would have printed in the
 * open, and the write-once outcome keeps its nonce single-use.
 *
