...
export default defineConfig({
  ...
  optimizeDeps: {
    ...
    // relative to import.meta.url (dev-mode only issue). @credkit/* is TS
    // source (.js specifiers) served through the resolver plugin pipeline,
    // which dev prebundling would bypass.
